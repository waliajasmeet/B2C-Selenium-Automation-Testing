...
# From City input and first suggestion (uses Google Places Autocomplete — pac-container outside form)
...
# To City input and first suggestion (uses Google Places Autocomplete — pac-container outside form)
...
LOGIN_MOBILE_INPUT_XPATH = "//input[@placeholder='Enter mobile number']"
LOGIN_SEND_OTP_BUTTON_XPATH = "//button[contains(text(),'SEND OTP')]"
LOGIN_OTP_INPUT_XPATH = "//input[@placeholder='Enter 6-digit OTP']"
LOGIN_VERIFY_OTP_BUTTON_XPATH = "//button[contains(text(),'VERIFY OTP')]"
LOGIN_NICKNAME_XPATH = "//nav//span[@class='nav-link']/strong"
...
# Results page — header fields for validation
RESULTS_LOCATION_XPATH = "//div[@class='car-heading']//ul/li"
RESULTS_DATE_XPATH = "//div[@class='pickupdate']/p[not(@class)]"
RESULTS_TIME_XPATH = "//div[contains(@class,'pickuptime')]/p[not(@class)]"
...
# Order Summary — Booking page validation
ORDER_SUMMARY_SERVICE_TYPE_XPATH = "//td[contains(text(),'Service type')]/following-sibling::td"
ORDER_SUMMARY_PICKUP_CITY_XPATH = "//td[contains(text(),'Pickup City')]/following-sibling::td"
ORDER_SUMMARY_DATE_TIME_XPATH = "//td[contains(text(),'Date & Time')]/following-sibling::td"

# Booking form — Traveller Details
FIRST_NAME_XPATH = "//input[@placeholder='First Name']"
LAST_NAME_XPATH = "//input[@placeholder='Last Name']"
TRAVELLER_MOBILE_XPATH = "//input[@placeholder='Mobile Number']"
TRAVELLER_EMAIL_XPATH = "//input[@placeholder='Email id']"
TRAVELLER_PICKUP_LOCATION_XPATH = "//input[@placeholder='Enter Pickup Location']"
TRAVELLER_PICKUP_ADDRESS_XPATH = "//input[@placeholder='Enter Pickup Address']"
